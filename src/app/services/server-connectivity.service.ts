...
export class ServerConnectivityService {
  ...
  public sendPostReq(path: string, body: any, options: any): Observable<ArrayBuffer> {
    return this.httpClient.post(this.BASE_URL + path, body, options);
  }
  public sendPutReq(path: string, body: any, options: any): Observable<ArrayBuffer> {
    return this.httpClient.put(this.BASE_URL + path, body, options);
  }
  public sendPatchReq(path: string, body: any, options: any): Observable<ArrayBuffer> {
    return this.httpClient.patch(this.BASE_URL + path, body, options);
  }
  public sendDeleteRequest(path: string, options: any): Observable<ArrayBuffer> {
    return this.httpClient.delete(this.BASE_URL + path, options);
  }
  public sendGetRequest(path: string, options: any): Observable<ArrayBuffer> {
